...
public class UsuarioRepositoryTest {
	...
	void start() {
		...
		usuarioRepository.save(new Usuario(0L, "Manuela da Silva","manuela@email.com.br","13465278","https://i.imgur.com/FSTvs20.jpg"));
		
		usuarioRepository.save(new Usuario(0L, "Adriana da Silva","adriana@email.com.br","13465278","https://i.imgur.com/FCTvs20.jpg"));
		
		usuarioRepository.save(new Usuario(0L, "Paulo da Antunes","paulo@email.com.br","13465278","https://i.imgur.com/FVTvs20.jpg"));
